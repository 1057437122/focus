...
<head>
<meta name='yuntu' content='c9a34fdec296ab5c10e8f798ba93a27a'/>
<meta charset="<?php bloginfo( 'charset' ); ?>" />
<meta content="width=device-width, initial-scale=1.0, user-scalable=no" name="viewport">
<meta name="baidu-site-verification" content="LS2oegjfXY" />
...
<div id="logo"  class="span3 visible-desktop"><h1><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img width="230" height="80" src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.png" alt="leez" /></a></h1>  </div>
...
<img width="30" height="26" src="<?php echo get_template_directory_uri(); ?>/assets/img/home.png" alt="leez网" />
		        ...
		        <nav id="site-navigation" class="main-navigation navbar" role="navigation">
		            <div class="navbar-inner">
						...
						<a class="small-logo hidden-desktop" rel="home" title="风腾" href="<?php echo esc_url( home_url( '/' ) ); ?>">风腾</a>
						...
						<ul class="social-links visible-desktop">
							...
							<?php } ?>
							<?php if( $loginlink ) { ?>
							<li class="login"><a href="<?php echo wp_login_url( get_permalink() ); ?>" title="<?php _e('登录','dw-focus') ?>"><i class="icon-user"></i></a>
							<?php } ?>
						</ul><!-- End social links -->
