...
class dw_focus_top_posts extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array('classname' => 'dw_focus_top_posts news-slider', 'description' => __( '显示图像滑块小工具', 'dw_focus' ) );
        parent::__construct('dw_focus_news_slider', __( 'DW Focus: 滑块小工具', 'dw_focus' ), $widget_ops);
                                    ...
                                    <?php if( isset( $instance['meta'] ) && $instance['meta'] ) { ?>
                                        ...
                                        <?php 
                                            if( isset( $instance['author'] ) && $instance['author'] ) {
                                                ?>
                                                作者： <a href="<?php echo esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ); ?>" rel="author"><?php echo get_the_author(); ?></a>
                                                <?php
                                            }
                                        ?>
...
?>
        ...
        <p><label for="<?php echo $this->get_field_id('interval'); ?>"><?php _e('间隔时间（输入0禁用）:','dw_focus'); ?></label>
        <input id="<?php echo $this->get_field_id('interval'); ?>" name="<?php echo $this->get_field_name('interval'); ?>" type="text" value="<?php echo $interval; ?>" size="3" /><span class="description"><?php _e('秒','dw_focus') ?></span></p>
