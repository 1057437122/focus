...
class dw_focus_accordion_Widget extends dw_focus_dynamic_Widget {
    ...
    function dw_focus_accordion_Widget() {
        $widget_ops = array( 'classname' => 'dw_focus_accordion news-accordion', 'description' => __('显示手风琴小工具','dw_focus') );
        $this->WP_Widget( 'dw_focus_accordions', 'DW Focus:手风琴小工具', $widget_ops );
    }
