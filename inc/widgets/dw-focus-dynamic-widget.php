      ...
      function form( $instance ) {
        ...
        ?>
          ...
          <div class="dw-widget-extends" data-setting="#<?php echo $this->get_field_id('widgets') ?>" >
            <p class="description"><?php _e('拖放小工具在这里','dw_minion') ?></p>
            <?php
          ...
          <div class="widget-top">
            <div class="widget-title-action">
              ...
              <a class="widget-control-edit hide-if-js" href="<?php echo esc_url( add_query_arg( $query_arg ) ); ?>">
                <span class="edit"><?php _ex( '编辑', 'widget' ); ?></span>
                <span class="add"><?php _ex( '添加', 'widget' ); ?></span>
          ...
          <div class="widget-inside">
            <div class="widget-content">
              <?php if( isset($s['id_base'] ) ) { 
                ...
                echo "\t\t<p>" . __('这个小工具没有设置选项。','dw_minion') . "</p>\n"; 
              } ?>
            </div>
            ...
            <div class="widget-control-actions">
              <div class="alignleft">
                <a class="widget-control-remove" href="#remove"><?php _e('删除','dw_minion'); ?></a> |
                <a class="widget-control-close" href="#close"><?php _e('关闭','dw_minion'); ?></a>
              </div>
              <div class="alignright widget-control-noform">
                <?php submit_button( __( '保存', 'dw_minion' ), 'button-primary widget-control-save right', 'savewidget', false, array( 'id' => 'widget-' . esc_attr( $s['widget-id'] ) . '-savewidget' ) ); ?>
