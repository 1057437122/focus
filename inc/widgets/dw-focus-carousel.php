...
class dw_focus_videos extends WP_Widget {
    ...
    function __construct() {
        ...
        $widget_ops = array('classname' => 'dw_focus_videos', 'description' => __( "显示滚动图片新闻",'dw_focus') );
        parent::__construct('dw_focus_news_carousel', __('DW Focus: 滚动图片新闻','dw_focus'), $widget_ops);
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('最新文章','dw_focus') : $instance['title'], $instance, $this->id_base);
                ...
                <?php } ?>
                    ...
                    <article <?php post_class($class); ?>>
                        ...
                        <div class="entry-meta">
                            <time datetime="<?php echo get_post_time('c') ?>" class="entry-date"><?php echo get_post_time('Y-m-d') ?></time>
                        </div>
                    </article>
            <?php 
                $i++;
...
?>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('interval'); ?>"><?php _e( '间隔时间（输入0禁用）', 'dw_focus') ?></label>
            <input type="text" name="<?php echo $this->get_field_name('interval'); ?>" id="<?php echo $this->get_field_id('interval'); ?>" value="<?php echo $interval  ?>" class="small-text"> <span class="description"><?php _e('秒','dw_focus') ?></span>
        </p>
<?php
    }
}
