...
class dw_focus_latest_headlines extends WP_Widget {
    ...
    function __construct() {
        $widget_ops = array('classname' => 'dw_focus_headlines', 'description' => __( '显示选定的文章作为头条滚动', 'dw_focus') );
        parent::__construct('dw_focus_news_headlines', __('DW Focus: 头条滚动小工具', 'dw_focus' ), $widget_ops);
    ...
    function widget($args, $instance) {
        ...
        $title = apply_filters('widget_title', empty($instance['title']) ? __('头条新闻', 'dw_focus' ) : $instance['title'], $instance, $this->id_base);
